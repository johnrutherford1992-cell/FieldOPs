...
function CostCodeCard({ code, onDelete, onToggleActive }: CostCodeCardProps) {
  ...
  return (
    <div className="bg-glass border border-gray-100 rounded-xl shadow-glass-card p-4 relative">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <FormGroup label="CSI Division *" required>
            <select
              ...
              className="w-full px-4 py-3 border border-gray-100 rounded-lg text-field-base focus:outline-none focus:ring-2 focus:ring-accent-violet"
            >
          ...
          <FormGroup label="Notes">
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-100 rounded-lg text-field-base focus:outline-none focus:ring-2 focus:ring-accent-violet resize-none"
            />
          </FormGroup>
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-100">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-3 border border-gray-100 text-accent-violet rounded-xl font-semibold text-field-base hover:bg-alabaster transition-colors"
            >
              Cancel
            </button>
            <button
