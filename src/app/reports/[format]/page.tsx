    ...
    return (
      <AppShell>
        ...
        <div className="screen px-5 pt-6 pb-8">
          {/* Report Info Card */}
          <div className="bg-glass rounded-lg p-6 mb-6 border border-gray-100">
          ...
          {/* Logs Summary */}
          <div className="bg-glass rounded-lg p-4 mb-6 border border-gray-100">
  ...
  return (
    <AppShell>
      ...
      <div className="screen px-5 pt-6 pb-8">
        ...
        {/* Report Container */}
        <div className="bg-glass rounded-lg border border-gray-100 overflow-hidden">
          <div
